...
INSERT INTO `TED`.`Arthro` (`idArthro`, `User_id`, `Text`, `Photo`, `Video`) VALUES (4, 2, 'Hello, look here some plays in last nights lcs.. ', NULL, '');
INSERT INTO `TED`.`Arthro` (`idArthro`, `User_id`, `Text`, `Photo`, `Video`) VALUES (5, 4, 'Photoshooting', 'fani_pic.jpg', NULL);
INSERT INTO `TED`.`Arthro` (`idArthro`, `User_id`, `Text`, `Photo`, `Video`) VALUES (6, 1, 'Hello, its me', 'DSC_0101.jpg', NULL);
INSERT INTO `TED`.`Arthro` (`idArthro`, `User_id`, `Text`, `Photo`, `Video`) VALUES (7, 1, 'Olympiacos F.C', 'olympiakos_gazzetta.jpg', NULL);
...
INSERT INTO `TED`.`Aggelia` (`idAggelia`, `user_id`, `Title`, `Description`, `Requirements`, `Desired`, `Location`, `Workload`) VALUES (3, 3, 'CEO Manager2', 'It is a different CEO Manager this time... Evil corp strikes again', 'Everything is required of course.. hahahah', 'Every knowloedge ever.. +) If you are affiliated with the hacker underground community come and expose them!', 'Dunno', '24/7');
INSERT INTO `TED`.`Aggelia` (`idAggelia`, `user_id`, `Title`, `Description`, `Requirements`, `Desired`, `Location`, `Workload`) VALUES (4, 4, 'GOD', 'Hahaha thought the requiements couldn\'t be any higher? we are actually not even hiring anyone anymore!', 'Duh', 'Everything! Im kidding not even enough', '*blanc*', 'come on...');
INSERT INTO `TED`.`Aggelia` (`idAggelia`, `user_id`, `Title`, `Description`, `Requirements`, `Desired`, `Location`, `Workload`) VALUES (5, 1, 'DIT Professor', 'Just kidding - come work at Evil Corp plz...We are desperate now', 'Ok this time we dont require anything im sorry', 'Nothing?', 'Ahens', '1 hour per week');
